...
public class SessionUtil {
	...
	public static final List<Role> getCurrentUserRole() {
		...
		List<Role> roles = (List<Role>) SecurityUtils.getSubject().getSession().getAttribute(Constants.USER_ROLE);
		return roles;
	}
	...
	public static final List<String> getCurrentUserArea() {
		@SuppressWarnings("unchecked")
		List<String> nodes = (List<String>) SecurityUtils.getSubject().getSession().getAttribute(Constants.USER_NODE);
		return nodes;
	}
