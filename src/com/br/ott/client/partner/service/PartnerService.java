...
import com.br.ott.client.partner.entity.RoleToPartner;
...
public class PartnerService {
	 ...
	 * @return
	 */
	public Map<String, Object> getPartnerById(String id, List<Role> roles) {
		...
		map.put("editable",
				RoleToPartner.getEditable(partner.getStatus(), roles));
		return map;
	}
