...
public class JsonController extends BaseController {
	...
	public String JsonTest(HttpServletRequest request, HttpServletResponse response, Model view) throws OTTException {
		...
		String returnMsg = "";
		try {
			HashMap<String, Object> map = ApiTest.callMethod(urlValue, businessReq, pub);
			if (map == null) {
				urlValue = "";
				pub = "";
				businessReq = "";
