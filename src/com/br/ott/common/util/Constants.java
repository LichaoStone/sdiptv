...
public interface Constants {
	...
	public final static class DicType {
		...
		/** 收视率类型 */
		public static final String SSLLX = "SSLLX";
		/** 时间类型 */
		public static final String SJLX = "SJLX";
		/** 推荐类型 */
		public static final String TJLX = "TJLX";
		/** 硬件型号类型 */
		public static final String EQUIP_YJXH = "YJXH";
		/** 流程分类 */
		public static final String FLOW_TYPE = "FLOW";
		/** 产品准入流程 */
		public static final String FLOW_PRODUCT_ENTER = "FLOW_PRODUCT_ENTER";
		/** 产品服务准入流程 */
		public static final String FLOW_PRODUCTPROPS_ENTER = "FLOW_PRODUCTPROPS_ENTER";
		/** 合作伙伴准入流程 */
		public static final String FLOW_PARTNER_ENTER = "FLOW_PARTNER_ENTER";

		private static HashMap<String, String> flowType = new HashMap<String, String>();

		public static Map<String, String> getFlowType() {
			if (!flowType.isEmpty()) {
				return flowType;
			}
			flowType = new HashMap<String, String>();
			flowType.put(FLOW_PRODUCT_ENTER, "产品准入");
			flowType.put(FLOW_PARTNER_ENTER, "合作伙伴准入");
			flowType.put(FLOW_PRODUCTPROPS_ENTER, "产品服务准入");
			return flowType;
		}
	}
