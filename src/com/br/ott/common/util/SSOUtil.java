...
public final class SSOUtil {
	 ...
	 */
	public static Map<String, String> postFormDataByMap(String url,
	...
	public static void main(String[] args) {
		// testOrder();
		// String html =
		// submitFormResponse("http://localhost/SH_iptv_Server/test.html");
		// String url =
		// "http://222.66.209.188:8088/SH_iptv_Server/coin_returnConfirm.do";
		// System.out.println(getReturnURL(html, url));
		// System.out.println(getUrlData(url));
		// String[] arr = new String[] { "amount", "version", "game_id",
		// "description", "sp_id", "return_url", "order_id",
		...
		// Map<String, String> parmas = new HashMap<String, String>();
		// // parmas.put("sd", "fs");
		// System.out.println(parmas.isEmpty() + ":" + parmas.size());

		// System.out.println(submitFormResponse("http://localhost/epg/test/testEPG2.do"));

		// String epg = submitFormResponse("http://tv.cntv.cn/epg");
		// System.out.println(epg);
		// Document doc = Jsoup.parse(epg);
		// Elements indexs =doc.getElementsByClass("channel");
		// for (Element dl : indexs) {
		// System.out.println(dl.attr("rel")+"===="+dl.text());
		// Elements as =dl.getElementsByTag("a");
		// for(Element a: as){
		// System.out.println(a.attr("rel")+"===="+a.text());
		// }
		// }
		// Map<String, String> parmas = new HashMap<String, String>();
		// parmas.put("date", "2014-05-19");
		// parmas.put("channel", "cctv2");
		// String html =
		// submitFormResponse("http://tv.cntv.cn/index.php?action=epg-list",
		// parmas);
		// System.out.println(html);
		// Document document = Jsoup.parse(html);
		// Element programs = document.getElementById("epg_list");
		// Elements elements = programs.getElementsByTag("a");
		// if (elements.isEmpty()) {
		// System.out.println("无epg_list div属性返回");
		// return;
		// }
		// for (Element temp : elements) {
		// if (temp.hasClass("p_name_a") || temp.hasClass("p_name")) {
		// System.out.println(temp.text() + "==" + temp.attr("href"));
		// }
		// }
		// String s
		// =submitFormResponse("http://wmp.test.zhisland.com/oparty/userInfoById?id=cdqO7d4bd366e&s=42b227d601fdfd275525421088139cc7");
		// System.out.println(s);
		// getTvmaoHTML("http://www.tvmao.com/program/CCTV-CCTV3-w5.html#night");
		System.out
				.println(getHTMLByGBK("http://epg.tvsou.com/programws/TV_30/Channel_52/W3.htm"));
	}
}
