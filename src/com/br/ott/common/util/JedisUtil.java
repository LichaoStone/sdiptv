...
import redis.clients.jedis.BinaryClient.LIST_POSITION;
	...
	public class JedisUtil {
		...
		public static void main(String[] args) {
			...
			JedisUtil jutil = new JedisUtil("122.228.113.253",9733,100000,"02E4F70D-4292-39E4-CFB4-38DFB70B68FB",1);
			HashMap hmap = new HashMap<String, String>();
			hmap.put("id", "0007ed2888644d639d129aefbe1e7412");
			hmap.put("path", "movies/201312/1204/Will.It.Snow.for.Christmas.E14.720p.HDTV.x264-kurama.ts");
			hmap.put("size", "0");
